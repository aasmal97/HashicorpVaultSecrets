...
uses: aasmal97/HashicorpVaultSecrets@v2.1.0
with:
...
- [nektos/act](https://github.com/nektos/act) installed. This allows us to use Docker to create a container, that resembles a Github Action Environment for testing
